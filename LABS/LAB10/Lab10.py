...
class CosmologicalTools:
    ...
    def HubbleParameter(self, z):
        ...
        OmegaL= self.OmegaL0          # Omega dark energy, it is constant and no redshift dependence
...
if __name__ == '__main__':
    ...
    BenchMark= CosmologicalTools(OmegaM0_planck, OmegaL0_planck,OmegaL0_planck,h_planck)
    ...
    print(Desitter.HubbleParameter(0))
    

    # Is the recession velocity of a galaxy at a given distance larger or smaller than in the benchmark cosmology at z=1?
    #   Desitter is higher !v 
