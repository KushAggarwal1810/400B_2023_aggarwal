...
def Salpeter(m,m_min= 0.1 , m_max= 120, alpha =2.35):
    ...
    """ This is a function that defines the salpeter IMF. The function is going to be 
    normailized such that it returns the fraction of stars expected at the given m( assuming
        stars range in mass from m_min to m_max.
        ...
        Inputs :
            m: array of floats
             ...
             pwer law for salpeter function
             
             Outputs :
                 normalized_salpeter : float
                 normlaized fraction of stars at a given m.
        
     """
     
     # Determine hte magitude of the integral
...
def salpeter_Mass(m,m_min= 0.1 , m_max= 120, alpha =2.35):
    ...
    """ This is a function that defines the salpeter IMF. The function is going to be 
    normailized such that it returns the fraction of mass ( assuming
        stars range in mass from m_min to m_max.
        ...
        Inputs :
            m: array of floats
             ...
             Outputs :
                 normalized_salpeter : float
                 normlaized fraction of mass over a given m range
...
# Determine the fraction of mass in stars that are mosre massive than the sun
...
# 100 solar mass cluster

print(100*np.round(frac2[0],3)) # ie how much stellar mass I will have in that cluster

# 1 solar mass cluster
