...
# use this code to get a galaxy redshift
...
haloLMC1= 1.647e11  # original LMC halo mass

LMC2= AbundanceMatching(haloLMC1,0)
...
print(f'Steallr Mass of an L* galaxy at z=0 :{ np.around(MstarZ0.stellarMass()/1e10,2)}')

MstarZ1 = AbundanceMatching(10**(MosterZ1).logM1(), 1)

print(f'Steallr Mass of an L* galaxy at z=1 :{ np.around(MstarZ1.stellarMass()/1e10,2)}')
