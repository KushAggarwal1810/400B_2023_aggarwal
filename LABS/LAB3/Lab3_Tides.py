    ...
    Inputs :
     ...
     Outputs :
         ...
         mass : astropy qty
           ...
           total mass withing a given r in Msun
...
# Compute mass within 10,000 kpc

print(f"{hernquist_mass(10000*u.kpc):.2e}")  

# asnwer is 1.95, so even after 10000 kpc it didnt give full mass of MW ie 1.975 , as this profile is not truncated
...
mdisk = 7.5e10*u.Msun   # disk mass of the milky way
mbuldge = 1e10*u.Msun    # buldge mass of the milky way

mass_MW50 = hernquist_mass(50*u.kpc)+mdisk+mbuldge
...
def jacobi_mass(rj,r,m_host):
    ...
    Function that determined the minimum satellite mass needed to mantain the size
    of a given satellite using the jacobi radius calculation
    ...
    Inputs :
        ...
        Jacobi radius OR the observed steallar radius of the satellite in kpc
      ...
      Outputs :
          ...
          minimum satellite mass in M_sun      
...
distL = 50.0*u.kpc  # galactocentric distnace to the LMC
