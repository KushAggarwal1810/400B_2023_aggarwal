...
filename1= "E:/astr 400B class/ASTR400B_2023/Labs/Lab4/IsochroneData/Isochrone1.txt"
filename2= "E:/astr 400B class/ASTR400B_2023/Labs/Lab4/IsochroneData/Isochrone2.txt"
filename3= "E:/astr 400B class/ASTR400B_2023/Labs/Lab4/IsochroneData/Isochrone3.txt"
filename4= "E:/astr 400B class/ASTR400B_2023/Labs/Lab4/IsochroneData/Isochrone4.txt"
filename5= "E:/astr 400B class/ASTR400B_2023/Labs/Lab4/IsochroneData/Isochrone5.txt"
filename6= "E:/astr 400B class/ASTR400B_2023/Labs/Lab4/IsochroneData/Isochrone6.txt"
filename7= "E:/astr 400B class/ASTR400B_2023/Labs/Lab4/IsochroneData/Isochrone7.txt"
filename8= "E:/astr 400B class/ASTR400B_2023/Labs/Lab4/IsochroneData/Isochrone8.txt"
filename9= "E:/astr 400B class/ASTR400B_2023/Labs/Lab4/IsochroneData/Isochrone9.txt"
filename10= "E:/astr 400B class/ASTR400B_2023/Labs/Lab4/IsochroneData/Isochrone10.txt"
filename11= "E:/astr 400B class/ASTR400B_2023/Labs/Lab4/IsochroneData/Isochrone11.txt"
filename12= "E:/astr 400B class/ASTR400B_2023/Labs/Lab4/IsochroneData/Isochrone12.txt"
filename13 ="E:/astr 400B class/ASTR400B_2023/Labs/Lab4/IsochroneData/Isochrone13.txt"
filename14= "E:/astr 400B class/ASTR400B_2023/Labs/Lab4/IsochroneData/Isochrone13_5.txt"
...
data14 = np.genfromtxt(filename14,dtype=None,names=True,skip_header=8)
...
plt.plot(data2['B']-data2['R'], data2['R'], color='blue', linewidth=5, label='2 Gyr')
plt.plot(data3['B']-data3['R'], data3['R'], color='blue', linewidth=5, label='3 Gyr')
plt.plot(data4['B']-data4['R'], data4['R'], color='blue', linewidth=5, label='4 Gyr')
plt.plot(data5['B']-data5['R'], data5['R'], color='blue', linewidth=5, label='5 Gyr')
plt.plot(data6['B']-data6['R'], data6['R'], color='blue', linewidth=5, label='6 Gyr')
plt.plot(data7['B']-data7['R'], data7['R'], color='blue', linewidth=5, label='7 Gyr')
plt.plot(data8['B']-data8['R'], data8['R'], color='blue', linewidth=5, label='8 Gyr')
plt.plot(data9['B']-data9['R'], data9['R'], color='blue', linewidth=5, label='9 Gyr')
plt.plot(data10['B']-data10['R'], data10['R'], color='blue', linewidth=5, label='10 Gyr')
plt.plot(data11['B']-data11['R'], data11['R'], color='blue', linewidth=5, label='11 Gyr')
plt.plot(data12['B']-data12['R'], data12['R'], color='blue', linewidth=5, label='12 Gyr')
plt.plot(data13['B']-data13['R'], data13['R'], color='blue', linewidth=5, label='13 Gyr')
plt.plot(data14['B']-data14['R'], data14['R'], color='blue', linewidth=5, label='14 Gyr')
...
""" I added all the possible ages above."""
...
Galaxy mergers cause the bursts of star formation. 
"""
